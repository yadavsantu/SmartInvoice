  ...
  methods: {
    async loadInvoices(query = "") {
      try {
        ...
        const response = await axios.get("smart-invoice-topaz.vercel.app/api/v1/loadInvoice", {
    ...
    return;
      ...
      Swal.fire({
        ...
        const response = await axios.put(
          `smart-invoice-topaz.vercel.app/api/v1/updateInvoice/${invoiceId}`,
          {},
          { headers: { Authorization: `Bearer ${accessToken}` } }
        );
    ...
    async downloadInvoice(index) {
      ...
      try {
        const response = await axios.get(
          `smart-invoice-topaz.vercel.app/api/v1/download/${invoiceId}`,
